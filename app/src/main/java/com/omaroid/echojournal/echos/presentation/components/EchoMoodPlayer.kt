...
import com.omaroid.echojournal.core.presentation.designsystem.theme.MoodPrimary25
import com.omaroid.echojournal.core.presentation.designsystem.theme.MoodPrimary35
import com.omaroid.echojournal.core.presentation.designsystem.theme.MoodPrimary80
import com.omaroid.echojournal.core.presentation.util.formatMMSS
    ...
    Surface(
        ...
        Row(
            ...
            EchoPlayBar(
                ...
                amplitudeBasSpacing = amplitudeBarSpacing,
                powerRatio = powerRatios,
...
private fun EchoMoodPlayerPreview() {
    EchoJournalTheme {
        ...
        EchoMoodPlayer(
            ...
            totalPlaybackDuration = 300.seconds,
            powerRatios = ratios,
            onPlayClick = {},
            onPauseClick = {},
            modifier = Modifier
