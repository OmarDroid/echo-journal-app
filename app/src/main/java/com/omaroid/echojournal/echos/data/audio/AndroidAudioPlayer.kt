package com.omaroid.echojournal.echos.data.audio

import android.media.MediaPlayer
import com.omaroid.echojournal.echos.domain.audio.AudioPlayer
import com.omaroid.echojournal.echos.domain.audio.AudioTrack
...
class AndroidAudioPlayer(
    ...
    override fun stop() {
        // Clear the active track to ensure clean state for next playback
