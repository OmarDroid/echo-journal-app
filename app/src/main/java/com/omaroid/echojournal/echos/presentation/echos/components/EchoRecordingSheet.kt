...
import com.omaroid.echojournal.core.presentation.designsystem.theme.Pause
...
@Preview
@Composable
private fun SheetContentPreviewIsRecordingTrue() {
    EchoJournalTheme {
        SheetContent(
...
@Preview
@Composable
private fun SheetContentPreviewIsRecordingFalse() {
    EchoJournalTheme {
        SheetContent(
            formattedRecordDuration = "00:10:43",
            isRecording = false,
